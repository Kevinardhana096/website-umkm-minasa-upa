    ...
    >
      ...
      <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between bg-white">
        <div>
          ...
          {/* Merchant & Location */}
          <div className="mt-1.5 flex flex-wrap items-center gap-1.5 sm:gap-2 text-xs text-gray-500">
          ...
          {/* Short Description */}
          <p className="mt-2.5 sm:mt-3 text-xs sm:text-sm text-gray-600 line-clamp-2 leading-relaxed">
            {product.description}
          </p>
        </div>

        {/* Card Footer: Price, Stock & Detail CTA */}
        <div className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-gray-100 flex items-end justify-between gap-2 flex-wrap sm:flex-nowrap">
          <div>
